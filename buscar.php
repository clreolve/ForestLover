...
function search()
{
    ...
    if ($_GET) {
        if (isset($_GET['tag'])) {
            ...
            if (!isset($_GET['page'])) {
                header("location: ./buscar.php?page=1&tag={$_GET['tag']}");
                exit();
            }
            ...
            if (!isset($_GET['page'])) {
                header("location: ./buscar.php?page=1&specie={$_GET['specie']}");
                exit();
            }
            ...
            if (!isset($_GET['page'])) {
                header("location: ./buscar.php?page=1&forest={$_GET['forest']}");
                exit();
            }
